...
//ARDUINO 
#define BL_PIN_LED            16

#define CS_PIN_8876           5
#define MOSI_PIN_8876         23
#define MISO_PIN_8876         19
#define SCL_PIN_8876          18

/* SSD2828 interface define */
#define MOSI_8876(n)   digitalWrite(MOSI_PIN_8876, n)//MOSI
#define SCLK_8876(n)  digitalWrite(SCL_PIN_8876, n)//SCL
#define CS_8876(n)    digitalWrite(CS_PIN_8876, n)//CS
#define MISO_8876_Read  digitalRead(MISO_PIN_8876)
//sbit next  =P3^5;    //next
//#define CS_8876(n)    digitalWrite(CS_PIN_8876,n)//CS
#define BL(n)         digitalWrite(BL_PIN_LED,n);//BL
...
void Check_Power_is_Normal(void);//�� Normal mode ���x�_
void Check_Power_is_Saving(void);//�� Saving mode ���x�_
void Check_NO_Interrupt(void);//�]�� Interrupt ���x�_
void Check_Interrupt_Occur(void);//�� Interrupt ���x�_
...
//**[68h]~[73h]**//
void Line_Start_XY(unsigned short WX,unsigned short HY);		//�����c
void Line_End_XY(unsigned short WX,unsigned short HY);			//���K�c
void Triangle_Point1_XY(unsigned short WX,unsigned short HY);	//����-�c1
void Triangle_Point2_XY(unsigned short WX,unsigned short HY);	//����-�c2
void Triangle_Point3_XY (unsigned short WX,unsigned short HY);	//����-�c3
void Square_Start_XY(unsigned short WX,unsigned short HY);		//�����c
void Square_End_XY(unsigned short WX,unsigned short HY);		//���K�c
//**[76h]**//
...
//**[77h]~[7Eh]**//
void Circle_Center_XY(unsigned short WX,unsigned short HY);				//�A����
void Ellipse_Center_XY(unsigned short WX,unsigned short HY);			//�E�A����
void Circle_Radius_R(unsigned short WX);								//�A�돽
void Ellipse_Radius_RxRy(unsigned short WX,unsigned short HY);			//�E�A�돽
void Circle_Square_Radius_RxRy(unsigned short WX,unsigned short HY);	//�����D�ǰ돽
...
void LCD_PutChar(uint16_t x,uint16_t y,unsigned char c,uint16_t charColor,uint16_t bkColor);
...
void LCD_PutChar(uint16_t x,uint16_t y,unsigned char c,uint16_t charColor,uint16_t bkColor)
{
  ...
  for (i=0;i<24;i++)
  {
    tmp_char=ASCII_Table[((c-0x20)*24)+i];	 //�pȥ32��ƫ�ƣ�������ַ���Ŀո��_ʼ�ģ������ַ����ǵ�ע�
    for (j=0;j<16;j++)
    {
//      if ( (tmp_char >> 15-j) & 0x01 == 0x01)	����������@ʾ���ַ��ǵ��^��ģ����@����^�������
	if ( (tmp_char >> j) & 0x01 == 0x01)
      ...
      {
        LCD_SetPoint(x+j,y+i,bkColor); // �ַ��ɫ
      }
    }
  }
}
...
#ifdef IS42SM16160D
//Setting SDRAM (bank : 4��Row : A0-A12��Column : A0-A9��CAS : 2 & 3)
	LCD_RegisterWrite(0xe0,0xf9);	
	LCD_RegisterWrite(0xe1,0x02);	//CAS:2=0x02��CAS:3=0x03
...
#ifdef M12L32162A
//Setting SDRAM (bank : 2��Row : A0-A11��Column : A0-A7��CAS : 2 & 3)
...
#ifdef M12L2561616A
//Setting SDRAM (bank : 4��Row : A0-A12��Column : A0-A8��CAS : 2 & 3)
...
unsigned char SPI_Master_FIFO_Data_Put(unsigned char Data)
{
	...
	LCD_CmdWrite(0xB8);
	LCD_DataWrite(Data);
	while(Tx_FIFO_Empty_Flag()==0);	//�����و�����һ�P
...
unsigned char SPI_Master_FIFO_Data_Get(void)
{
   unsigned char temp;
	...
	while(Rx_FIFO_Empty_Flag()==1);//���ǿյ�������
	LCD_CmdWrite(0xB8);
	temp=LCD_DataRead();
	//while(Rx_FIFO_full_flag()); //�B�m����16�P�Y�ϲ���Ҫ
   return temp;
}
//REG[B9h] SPI master Control Register (SPIMCR2) 
void Mask_SPI_Master_Interrupt_Flag(void)
